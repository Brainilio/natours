...
export declare const getStartIndex: (index: any, childrenLength: any) => number;
export declare const getUpdateSlidePositionIndex: (activeIndex: any, itemsCount: any) => any;
